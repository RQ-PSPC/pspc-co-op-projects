export function AnastasiaFooter() {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-ado-text font-montserrat text-15 leading-7 tracking-tight">
            <p>Website made by Rachel Qi, Student</p>
            <p>Risk Assessment Program pages made by Anastasia Sadovskyy, CO-OP Student</p>
          </div>
          
          {/* Social Icons */}
          <div className="flex items-center space-x-4">
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/anastasia-sadovskyy-8aa49a340/" 
              target="_blank"
            ...
            {/* Email */}
            <a href="mailto:Anastasia.sadovskyy@tpsgc-pwgsc.gc.ca" className="text-ado-text hover:text-ado-primary transition-colors">
